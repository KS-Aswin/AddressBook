                                    ...
                                    <div class="formData d-flex flex-column gap-4">
                                        ...
                                        <div class="d-flex gap-3">
                                            ...
                                            <div class="d-flex flex-column">                                            
                                                ...
                                                <input type="date" id="strDate" name="strDate" value="#variables.dateDOB#">
                                            </div>
                                        </div>
                                        <div class="d-flex gap-3">
                                            <div class="d-flex flex-column ">                                            
                        ...
                        <cfloop array="#contacts#" index="contact">
                            <cfif session.intUid eq contact.getuserId()>
                                <tr class="tableRow" id="">
                                    ...
                                    <th><button type="button" class="listBtn m-0" data-bs-toggle="modal" data-bs-target="##myModal">
                                        <a href='?action=list&intContactId=#contact.getcontactId()#'>EDIT</a>
                                    </button></th>
                                    <th><button type="button" class="listBtn deleteBtn m-0" id="" data-id="#contact.getcontactID()#">DELETE</button></th>
                                    <th>
                                        <button type="button" class="listBtn m-0" data-bs-toggle="modal" data-bs-target="##viewAccount">
                                            <a href='?action=list&intContactId=#contact.getcontactId()#'>VIEW</a>
                                        </button>
                                                    ...
                                                    <div class="d-flex justify-content-between gap-3">
                                                            ...
                                                            <div class="ps-5 py-5 d-flex flex-column justify-content-between formSide gap-3">
                                                                ...
                                                                <div class="viewContactDetails d-flex align-items-center ">
                                                                    ...
                                                                    <p class="mb-0">#variables.strTitle#.#variables.strFirstName# #variables.strLastName#</p>
                                                                </div>
                                                                <div class="viewContactDetails d-flex align-items-center ">
                                                                    <div class="d-flex justify-content-between w-50">
                                                                    ...
                                                                    <p class="mb-0">#variables.strGender#</p>
                                                                </div>
                                                                <div class="viewContactDetails d-flex align-items-center ">
                                                                    <div class="d-flex justify-content-between w-50">
                                                                    ...
                                                                    <p class="mb-0">#variables.dateDOB#</p>
                                                                </div>
                                                                <div class="viewContactDetails d-flex align-items-center ">
                                                                    <div class="d-flex justify-content-between w-50">
                                                                    ...
                                                                    <p class="mb-0">#variables.strAddress#, #variables.strStreet#</p>
                                                                </div>
                                                                <div class="viewContactDetails d-flex align-items-center ">
                                                                    <div class="d-flex justify-content-between w-50">
                                                                    ...
                                                                    <p class="mb-0">#variables.intPinCode#</p>
                                                                </div>
                                                                <div class="viewContactDetails d-flex align-items-center ">
                                                                    <div class="d-flex justify-content-between w-50">
                                                                    ...
                                                                    <p class="mb-0">#variables.strEmailId#</p>
                                                                </div>
                                                                <div class="viewContactDetails d-flex align-items-center ">
                                                                    <div class="d-flex justify-content-between w-50">
                                                                    ...
                                                                    <p class="mb-0">#variables.intPhoneNumber#</p>
                                                                </div>
